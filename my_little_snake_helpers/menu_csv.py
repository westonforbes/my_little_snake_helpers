# When running this script directly, use launch.json to run as a module.
    ...
    def show_menu(self, starting_dir = None):
        ...
        while True:
            ...
            if selection_text == 'load csv':
                ...
                csv_file_path = file_processor.open_file(starting_dir, filetypes=[("CSV files", "*.csv")])
            ...
            if selection_text == 'drop columns':
                ...
                csv_df = self._drop_columns_menu(csv_df)
...
if __name__ == "__main__":
    ...
    # Create an instance of CSVMenu.
    csv_menu = MenuCSV()
    
    # Show the CSV menu and get the selected file path and DataFrame.
    file_path, dataframe = csv_menu.show_menu()